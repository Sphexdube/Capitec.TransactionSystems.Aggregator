...
{
    public sealed class GetTransactionsByCategoryRequestValidator : AbstractValidator<GetTransactionsByCategoryRequest>
    {
        public GetTransactionsByCategoryRequestValidator()
        {
