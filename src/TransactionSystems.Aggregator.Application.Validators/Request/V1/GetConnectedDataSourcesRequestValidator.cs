...
{
    public sealed class GetConnectedDataSourcesRequestValidator : AbstractValidator<GetConnectedDataSourcesRequest>
    {
        public GetConnectedDataSourcesRequestValidator()
        {
